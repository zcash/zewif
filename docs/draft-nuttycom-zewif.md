...
ufvk           = tstr           ; canonical ZIP 316 encoding
sapling-extfvk = bytes169       ; canonical ZIP 32 extended FVK encoding
sprout-vk      = bytes67        ; canonical encoding: 3-byte version prefix
                                ; followed by a_pk and sk_enc
...
sapling-key-entry = {
  0: bytes169,                  ; the canonical encoding of the extended full
                                ; viewing key this spending key corresponds to
  1: bytes169,                  ; canonical extended spending key encoding
}

sprout-key-entry = {
  0: tstr,                      ; Sprout address
  1: bytes34,                   ; Sprout spending key, canonical encoding:
                                ; 2-byte network version prefix followed by
                                ; a_sk
}
...
bytes34  = bstr .size 34
bytes67  = bstr .size 67
bytes169 = bstr .size 169
